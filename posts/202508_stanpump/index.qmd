...
If we want to solve the ODE system while taking into account the infusion term $J$, the equation becomes more complicated @shafer_algorithms_1992,@bailey_simple_1991. This equation introduces coefficients $c_ji$ which are outlined below.
...
In this case, the vector B contains a fourth term for the effect compartment, $k_e0$ is added as a fourth term to $\lambda$ and different coefficients $c_e$ are used.
...
\\
e^p_2 & = c_{p1} \cdot \frac{k_{e0}}{k_{e0} - \lambda_1}
\\
